      ...
      <div className="d-flex justify-content-between align-items-center mb-5">
        <div>
          ...
          <p className="text-muted mb-0">
            Query and export your Stripe financial records
          </p>
        </div>
        {isKeySaved ? (
          <Badge
            bg="success-subtle"
            className="text-success border border-success p-2 px-3 rounded-pill"
          >
            ● Connection Active
          </Badge>
        ) : (
          <Badge
            bg="danger-subtle"
            className="text-danger border border-danger p-2 px-3 rounded-pill"
          >
            ○ Key Required
          </Badge>
        )}
          ...
          <div className="sticky-top" style={{ top: "2rem" }}>
            <Card className="border-0 shadow-sm rounded-4 mb-4">
              <Card.Body className="p-4">
                <h6
                  className="fw-bold mb-3 text-uppercase text-muted"
            ...
            <Card className="shadow-sm">
              <Card.Header className="bg-light fw-bold">Parameters</Card.Header>
              <Card.Body>
                <Form.Control
                  type="text"
                  name="searchQuery"
                  placeholder='ID: cus_123  |  Search: email:"foo@bar.com"'
                  value={queryParams.searchQuery}
                  onChange={handleInputChange}
                />
                <small className="text-muted" style={{ fontSize: "0.7rem" }}>
                  Paste a Stripe ID for direct lookup, or use Stripe query
                  syntax for search.
                </small>
                ...
                <Form.Group>
                  <Form.Label className="small fw-bold">Fetch Limit</Form.Label>
                  <Form.Select
                    name="limit"
        ...
        <Col lg={9}>
          <Card className="border-0 shadow-sm rounded-4 overflow-hidden mb-4">
            <div className="p-4 bg-white border-bottom">
              <h6
                className="fw-bold mb-4 text-uppercase text-muted"
                style={{ fontSize: "0.75rem", letterSpacing: "1px" }}
              >
              ...
              {!isKeySaved && (
                <div className="text-center mt-3">
                  <small className="text-danger">
                    ⚠️ Please save your Restricted API Key to enable queries.
                  </small>
                </div>
              )}
            </Card.Body>
          ...
          <div className="bg-white rounded-4 shadow-sm p-4 overflow-hidden">
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              <div className="small text-muted">
                Total records: {fetchedData.length}
              </div>
            </div>
