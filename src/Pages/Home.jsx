          ...
          <Row className="align-items-center">
            <Col lg={6}>
              ...
              <p className="lead text-secondary mb-4">
                A secure, client-side UI to retrieve payments, subscriptions, and customers. 
              ...
              <Card className="shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <Card.Body className="p-4 bg-light">
                  <Form.Group className="mb-3">
                    <Form.Label className="small fw-bold">RESTRICTED_API_KEY</Form.Label>
                    <Form.Control type="password" placeholder="rk_live_••••••••••••••••" disabled />
                  </Form.Group>
        ...
        <Container className="py-5">
          <Row className="text-center mb-5">
            <Col>
              ...
              <p className="text-muted">Built for speed, privacy, and technical ease.</p>
            </Col>
          </Row>
          <Row>
            {[
              { title: 'No Storage', text: 'We never store your keys or data. It stays in your browser memory and disappears on refresh.', icon: '🛡️' },
              { title: 'Reconciliation Ready', text: 'Quickly compare Stripe IDs with your internal records using our fetch mechanism.', icon: '⚖️' },
              { title: 'Restricted Access', text: 'Optimized for Stripe Restricted Keys to ensure least-privilege security.', icon: '🔑' }
            ].map((feature, idx) => (
